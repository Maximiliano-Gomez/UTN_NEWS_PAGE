    ...
    <main>
        <div class="columnaizquierda"> 
            ...
            <article>
                ...
                <?php
                    $sql = "select * from noticia where id=15";
                    $respuesta = mysqli_query($conexion, $sql);
                    $fila = mysqli_fetch_array($respuesta);
                ?>
                <img src="<?php echo $fila['imagen_1'];?>" alt="Algo">

                <a href="https://www.bbc.com/mundo/noticias-internacional-49892850">
                    <?php
                         echo $fila["titulo"];
                    ?>
                </a>
            ...
            <article>
                ...
                <?php
                    $sql = "select * from noticia where id=16";
                    $respuesta = mysqli_query($conexion, $sql);
                    $fila = mysqli_fetch_array($respuesta);
                ?>
                <img src="<?php echo $fila['imagen_1'];?>" alt="Algo">
        ...
        <div class="columnaderecha">
            ...
            <article>
                <H4>ACTUALIDAD</H4><br>
                <?php
                    $sql = "select * from noticia where id=13";
                    $respuesta = mysqli_query($conexion, $sql);
                    $fila = mysqli_fetch_array($respuesta);
                ?>
                <img src="<?php echo $fila['imagen_1'];?>" alt="algo">
            ...
            <article>
                <h5>--</h5>
                <?php
                    $sql = "select * from noticia where id=14";
                    $respuesta = mysqli_query($conexion, $sql);
                    $fila = mysqli_fetch_array($respuesta);
                ?>
                <img src="<?php echo $fila['imagen_1'];?>" alt="Algo">
